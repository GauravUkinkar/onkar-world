      ...
      <div className="faq-container container">
        <div className="faq-left">
          <div className="faq-heading-section">
            ...
            <p>
            Have questions about our products, services, or how we operate? Find clear and concise answers to your most frequently asked questions here. From sourcing and procurement to shipping and delivery, we have got you covered.
            </p>
          </div>
          {/* Accordion */}
        ...
        <div className="faq-right">
          <div className="faq-right-container">
            <div className="form-content">
              ...
              <p>Fill in the form below and get all your enquiries answered.</p>
            </div>
            {/* Form */}
            <div className="form-container">
              <form action="" className="faq-form" onSubmit={(e) => Submit(e)}>
                ...
                <input type="number" name="telephone" placeholder="Phone"  value={formData.Phone}
                onChange={(e) =>
                  setFormData({ ...formData, Phone: e.target.value })
                } required/>
                <textarea rows="5" placeholder="Message"   value={formData.Message}
                onChange={(e) =>
                  setFormData({ ...formData, Message: e.target.value })
                }/>
                <button type="submit" className="cta-btn cta-btn-rev hand-dark">
                  <p className="hand-dark">{loading ? "Submitting ..." : "ASK US"}</p>
                </button>
              </form>
            </div>
            {/* End of form */}
