...
function TwoCol({ title, content, background,type, direction }) {
  ...
  return (
    <>
      <div className="service-parent1 parent" ref={sectionRef}>
        <div className="container service-container" style={{flexDirection : `${direction}`}}>
